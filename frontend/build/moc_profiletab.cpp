...
void ProfileTab::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (ProfileTab::*)();
            if (_q_method_type _q_method = &ProfileTab::onAlbomClickedSignal; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (ProfileTab::*)(track * );
            if (_q_method_type _q_method = &ProfileTab::onTrackDoubleClickedignal; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void ProfileTab::onAlbomClickedSignal()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void ProfileTab::onTrackDoubleClickedignal(track * _t1)
{
